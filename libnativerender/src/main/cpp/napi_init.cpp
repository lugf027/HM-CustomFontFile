...
static napi_value Init(napi_env env, napi_value exports) {
    napi_property_descriptor desc[] = {
        ...
        {"GetXComponentStatus", nullptr, PluginManager::GetXComponentStatus, nullptr, nullptr, nullptr, napi_default,
         nullptr},
        {"DrawWithCustomFont", nullptr, PluginManager::DrawWithCustomFont, nullptr, nullptr, nullptr, napi_default, nullptr},
...
static napi_module demoModule = {
    ...
    .nm_modname = "libnativerender",
    .nm_priv = ((void *)0),
    .reserved = {0},
};

extern "C" __attribute__((constructor)) void RegisterLibnativerenderModule(void) { napi_module_register(&demoModule); }
